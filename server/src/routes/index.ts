...
import collegeInstructorRouter from "./college-instructor";
...
export { userRouter, collegeStudentRouter, collegeSubjectRouter, collegeInstructorRouter, webhookRouter, authRouter, samsRouter, gmsRouter  };